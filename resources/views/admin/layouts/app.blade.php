...
<body class="app sidebar-mini">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="index.html">Trends Clothes</a>
    ...
    <script type="text/javascript" src="{{ asset('admin-asset/js/plugins/chart.js') }}"></script>
