...
@section('content')
    ...
    <div class="app-title">
        <div>
            <h1><i class="fa fa-th-list"></i> Category Tables</h1>
        </div>
        <ul class="app-breadcrumb breadcrumb">
            <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
            <li class="breadcrumb-item">Tables</li>
            <li class="breadcrumb-item active"><a href='{{ route('categories.index') }}'>Category Tables</a></li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="tile">
                <div class="row">
                    ...
                    <div class="col-6 d-flex justify-content-end">
                        ...
                        <div class="col-3">
                            <a href="{{ route('categories.create') }}" class="btn btn-primary pull-right">NewCategory</a>
                        </div>
                        {{-- </div> --}}
                    </div>
                </div>
                ...
                <table class="table table-hover table-bordered dataTable no-footer">
                    <thead>
                        <tr>
                            ...
                            <th class="sorting sorting_asc" width="100">Status</th>
