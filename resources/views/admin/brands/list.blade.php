...
@section('content')
    ...
    <div class="app-title">
        <div>
            <h1><i class="fa fa-th-list"></i> Brands Tables</h1>
        </div>
        <ul class="app-breadcrumb breadcrumb">
            <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
            <li class="breadcrumb-item">Tables</li>
            <li class="breadcrumb-item active"><a href='{{ route('brands.index') }}'>Brands Tables</a></li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <svg class="text-danger h-6 w-6" xmlns="http://www.w3.org/2000/svg"
                                                fill="none" viewBox="0 0 24 24" stroke-width="2" width="20%"
